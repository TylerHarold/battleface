...
__webpack_require__.g.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
...
function registerRegisterButton() {
  $("#register").on("click", function () {
    ...
    axios.post('/api/auth/register', data).then(function (res) {})["catch"](function (err) {
      alert(err);
    });
  });
}
